    ...
    <div className="grid min-h-screen grid-cols-1 bg-floor lg:grid-cols-[15.5rem_1fr]">
      ...
      <div className="flex min-w-0 flex-col pb-[4.25rem] lg:pb-0">
        ...
        <MobileTabBar items={[
          ...
          { label: 'Pregled', icon: 'dashboard', href: '/owner' },
...
const I: Record<string, Icon> = {
  ...
  users: (p) => (<svg viewBox="0 0 24 24" className={p.className} fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13A4 4 0 0 1 16 11"/></svg>),
...
const NAV: NavItem[] = [
  ...
  { href: '/owner/users', label: 'Uporabniki', icon: 'users' },
