          ...
          {menuOpen && (
            <div role="menu" className="absolute right-0 top-full z-30 mt-2 w-56 overflow-hidden rounded-card border border-line bg-surface py-1 shadow-lift">
              <div className="border-b border-line px-4 py-2">
                ...
                <p className="text-xs text-muted2">Skladišče · A-SPRINT</p>
              </div>
              <Link href="/warehouse/settings" role="menuitem" className="flex items-center gap-2.5 px-4 py-2.5 text-sm font-semibold text-ink hover:bg-floor">
